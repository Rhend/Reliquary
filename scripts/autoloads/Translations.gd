...
const STRINGS: Dictionary = {
	"fr": {
		...
		"building.route.craftsmen_locked": "Vos artisans ne sont pas encore assez expérimentés pour reconstruire cette route. Ce chantier s'ouvrira quand le Village aura grandi (Peu Commun).",
	...
	"en": {
		...
		"building.route.craftsmen_locked": "Your craftsmen aren't experienced enough to rebuild this road yet. This work opens once the Village has grown (Uncommon).",
